 ...
 * founder re-creation après extinction de la lignée.
...
async function main(): Promise<void> {
  ...
  // White-box: teleports the founders side by side, weakens Abel.
  ...
  // Abel's lineage is extinct: his god may shape a new founder.
