...
const EN: Dict = {
  ...
  "creation.close": "Esc — back to the world",
  "creation.line-alive": "Your line is still standing. Look, change your mind, then press Esc.",
...
const FR: Dict = {
  ...
  "creation.close": "Échap — retour au monde",
  "creation.line-alive": "Ta lignée tient encore debout. Regarde, change d'avis, puis appuie sur Échap.",
